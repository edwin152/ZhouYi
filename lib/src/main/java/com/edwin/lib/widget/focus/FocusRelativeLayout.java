...
import com.edwin.lib.widget.rect.RectRelativeLayout;
...
public class FocusRelativeLayout extends RectRelativeLayout implements Focus {
    ...
    public FocusRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("CustomViewStyleable")
    public FocusRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
